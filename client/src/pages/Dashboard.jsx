    ...
    <div className='h-full overflow-y-scroll p-6'>
        <div className='flex justify-start gap-10 flex-wrap'>
            ...
            <div className='flex justify-between items-center w-72 p-4 px-6 bg-white rounded-xl border border-gray-200'>
                ...
                <div className='w-10 h-10 rounded-lg bg-gradient-to-br from-[#3588F2] to-[#0BB0D7] text-white
            ...
            <div className='flex justify-between items-center w-72 p-4 px-6 bg-white rounded-xl border border-gray-200'>
                ...
                <div className='w-10 h-10 rounded-lg bg-gradient-to-br from-[#FF61C5] to-[#9E53EE] text-white
                flex justify-center items-center'>
        ...
        <div className='space-y-3 '>
            ...
            {
                creations.map(( item ) => <CreationItems key={item.id} Itm = {item} />)
            }
        </div>
    </div>
  );
